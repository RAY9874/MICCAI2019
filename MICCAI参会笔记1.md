...
<img src="imgs/Multi Scale Curriculum CNN for Context-Aware Breast MRI Malignancy Classiﬁcation_model.JPG" style="zoom:80%;" />
...
<img src="imgs/Multi Scale Curriculum CNN for Context-Aware Breast MRI Malignancy Classiﬁcation_results.JPG" style="zoom:80%;" />
...
<img src="imgs/Quantifying and Leveraging Classiﬁcation Uncertainty for Chest Radiograph Assessment model .JPG" style="zoom:80%;" />
...
<img src="imgs/Accurate Esophageal Gross Tumor Volume Segmentation in PETCT using Two-Stream Chained 3D Deep Network Fusion sample.JPG" style="zoom:80%;" />

## 模型实验

双路的Unet变种（decoder端加了与FPN相似的结构）

<img src="imgs/Accurate Esophageal Gross Tumor Volume Segmentation in PETCT using Two-Stream Chained 3D Deep Network Fusion model.JPG" style="zoom:80%;" />
...
<img src="imgs/Accurate Esophageal Gross Tumor Volume Segmentation in PETCT using Two-Stream Chained 3D Deep Network Fusion result.JPG" style="zoom:80%;" />
...
<img src="imgs/Dual-Stream Pyramid Registration Network model.JPG" style="zoom:80%;" />
...
<img src="imgs/Dual-Stream Pyramid Registration Network result.JPG" style="zoom:80%;" />
...
<img src="imgs/PseudoEdgeNet Nuclei Segmentation only with Point Annotations model.JPG" style="zoom:80%;" />
...
<img src="imgs/PseudoEdgeNet Nuclei Segmentation only with Point Annotations result.JPG" style="zoom:80%;" />
